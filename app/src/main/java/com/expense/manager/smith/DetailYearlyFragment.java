...
public class DetailYearlyFragment extends DetailFragment {
    public void onViewCreated(View view, Bundle bundle) {
        ...
        getView().findViewById(R.id.nextMonth).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view2) {
                DetailYearlyFragment.this.W.add(1, 1);
    ...
    public void updateScreen() {
        ((TextView) getView().findViewById(R.id.currentMonth)).setText(new SimpleDateFormat("yyyy", Locale.US).format(this.W.getTime()));
        ...
        this.c0 = simpleDateFormat.format(calendar.getTime());
        updateUI();
    }

    public String getMessageText() {
        return new SimpleDateFormat("yyyy", Locale.US).format(this.W.getTime());
    }
}
