...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_add_shadow, false);
        this.mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_shadow_color, 0);
        a.recycle();
        init();
    }
    ...
    private void updateShaderMatrix() {
        ...
        matrix.postTranslate(((float) ((int) (f3 + 0.5f))) + rectF.left, ((float) ((int) (0.5f + f))) + rectF.top);
